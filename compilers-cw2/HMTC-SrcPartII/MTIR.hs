...
data Expression
    ...
    | ExpCond {
          ecCond    :: Expression,      -- ^ Boolean condition expression
          ecTrue    :: Expression,      -- ^ If-branch expression
          ecFalse   :: Expression,      -- ^ Else-branch expression
          expType   :: Type,            -- ^ Type (of resulting expression)
          expSrcPos :: SrcPos
      }
    -- | Array expression
    | ExpAry {
