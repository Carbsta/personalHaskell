...
elsifs : { [] }
       | ELSIF expression THEN command elsifs { ($2, $4) : $5 }
...
command
    ...
    | IF expression THEN command elsifs
        { CmdIf {ciCond = $2, ciThen = $4, ciElsifs = $5, ciElse = Nothing, cmdSrcPos = $1} }
    | IF expression THEN command elsifs ELSE command
        { CmdIf {ciCond = $2, ciThen = $4, ciElsifs = $5 , ciElse = Just $7, cmdSrcPos = $1} }
